# sagitta-stack organization defaults
...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`sagitta-stack`](https://github.com/sagitta-stack).

## Canonical organization links

- GitHub organization: https://github.com/sagitta-stack
- Public organization defaults: https://github.com/sagitta-stack/.github
- Canonical Linear project: https://linear.app/denman/project/githubcomsagitta-stack-60010601f42d
...
`sagitta-stack` declares repository roles, dependency edges, cross-organization capabilities, deployment ownership, and the git-submodule/Zed-package contract:
